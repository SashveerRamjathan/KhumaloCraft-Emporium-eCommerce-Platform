...
namespace ST10361554_CLDV6211_POE_Part_2.Areas.Identity.Pages.Account
{
    public class RegisterArtistModel : PageModel
    {
        ...
        private readonly ILogger<RegisterArtistModel> _logger;
        ...
        public RegisterArtistModel(
            ...
            ILogger<RegisterArtistModel> logger,
        ...
        public class InputModel
        {
            ...
            [Required]
            [DataType(DataType.Text)]
            [Display(Name = "Short Description of Yourself")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // Assign "Artist" role to the user
                    await _userManager.AddToRoleAsync(user, "Artist");

                    // Save additional data to the Artist model
                    var artist = new Artist
                    {
                        ArtistId = user.Id,
                        ArtistName = Input.FullName,
                        ArtistEmail = Input.Email,
                        ArtistDescription = Input.Description
                    };
